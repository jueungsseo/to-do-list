  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-200">
      <div className="flex items-center gap-2">
        ...
        <div>
          <h2 className="text-xl font-bold text-slate-900">Task Categories</h2>
          <p className="text-xs text-slate-500">Filter and organize your tasks by project domains.</p>
        </div>
      </div>
      ...
      {filteredTasks.length === 0 ? (
        <div className="bg-white rounded-2xl p-10 text-center border border-slate-200/80">
          ...
          <p className="font-semibold text-slate-700 text-sm">No Tasks in this Category</p>
        </div>
      ) : (
